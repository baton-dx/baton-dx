...
describe("CursorAdapter", () => {
  ...
  describe("getPath", () => {
    it("should return correct project paths", () => {
      ...
      expect(adapter.getPath("agents", "project", "helper")).toContain(".cursor/agents/helper.md");
    ...
    it("should return correct global paths", () => {
      ...
      expect(adapter.getPath("memory", "global", "AGENTS.md")).toContain("/.cursor/AGENTS.md");
    });
  });
