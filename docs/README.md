...
Welcome to the Baton documentation. Baton is a CLI package manager for Developer Experience & AI configuration.

## Getting Started

- [Installation](./01-installation.md) — Prerequisites and install methods
- [Quick Start](./02-quickstart.md) — Get running in 5 minutes
